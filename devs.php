...
<div class="container-fluid devs-page">
  ...
  <div class="flip-card">
    <div class="flip-card-inner">
      ...
      <div class="flip-card-back">
        ...
        <p class="descricao">
        Desenvolveu soluções integradas que abrangem desde a gestão de acesso e segurança dos usuários até a implementação de tecnologias interativas e a arquitetura visual da plataforma.
        </p>
  ...
  <div class="flip-card">
    <div class="flip-card-inner">
      <div class="flip-card-front">
        <img src="../clothing/assets/img/miguel.jpg">
        <h2>Miguel</h2>
      </div>
  ...
  <div class="flip-card">
    <div class="flip-card-inner">
      <div class="flip-card-front">
        <img src="../clothing/assets/img/rodrigo.jpg">
        <h2>Rodrigo</h2>
      </div>
